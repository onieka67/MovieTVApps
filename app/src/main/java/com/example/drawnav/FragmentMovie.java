...
public class FragmentMovie extends Fragment {
    ...
    private void getDatabasePath() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl(InterfaceMovie.JSONURL)
                .addConverterFactory(ScalarsConverterFactory.create())
                .build();

        InterfaceMovie interfaceMovie = retrofit.create(InterfaceMovie.class);

        Call<String> stringCall = interfaceMovie.getString();
    ...
    private void writeRecycler(String response){
        try {
            ...
            if(jsonObject.optString("page").equals("1")){
                ...
                adapterMovie = new AdapterMovie(getActivity(),movieArrayList);
